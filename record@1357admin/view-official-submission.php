...
<div class="content-wrapper">
  <section class="content-header">
    <h1> Manage Official submission <small>View Official submission</small> </h1>
    <ol class="breadcrumb">
      <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">View Official submission</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View Official submission</h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <a href="add-official-submission.php" class="btn btn-success" style="float: right;">Add Official submission</a>
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th>S.No</th>
                    <th>Official submission</th>
                    <th>Category</th>
                    <th>Image</th>
                    <th>Date</th>
                    <th>Status</th>
                ...
                <tbody>
                  ...
                  foreach ($cateogryQuery as $row) :
                    $category = $function->getSingleItem($row['category'],"official_selection_category")['name'];
                  ?>
                    <tr>
                      <td><?php echo $i++; ?></td>
                      ...
                      <td>
                        <a href="add-official-submission.php?id=<?php echo base64_encode($row['id']); ?>"><i class="fa fa-edit"></i></a>
                        ||
