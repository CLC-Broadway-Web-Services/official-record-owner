...
if (isset($_POST['add'])) {
  ...
  if ($result === true) {
    $msg = 'Home section6 has been added successfully ..';
  } else {
...
if (isset($_POST['update'])) {
  ...
  if ($result === true) {
    $msg = 'Home section6 has been updated successfully ..';
  } else {
    $errmsg = "Sorry Some Error !! Accurd ..$result";
  }
$editval =  $function->getSingleItem($id,$table);
...
<div class="content-wrapper">
  <section class="content-header">
    <h1> Manage Home section6 </h1>
    <ol class="breadcrumb">
      <li><a href="/record@1357admin/home.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"><?= ucwords($button) ?> Home section6</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box box-warning">
          <div class="box-header with-border">
            <h3 class="box-title"><?= ucwords($button) ?> Home section6 Items</h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <form name="myAboutUs" id="myAboutUs" method="post" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-4">
                  <a href="/record@1357admin/view-home-section6.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Go Back</a>
                </div>
                <div class=" col-sm-4">
