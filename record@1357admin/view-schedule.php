      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View Schedules</h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <div class="table-responsive">
              <a href="add-schedule" class="btn btn-success" style="float: right;">Add Schedule</a>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><a href="dist/img/<?php echo $row['pdf']; ?>" target="_blank">pdf</a></td>
                      <td><?php echo date('d-m-Y', strtotime($row['created_at'])); ?></td>
                      <td>
                        <a href="?status=<?= $row['status'] ? 0 : 1 ?>&id=<?php echo $row['id']; ?>"><i class="fa fa-toggle-<?= $row['status'] ? "on" : "off" ?>"></i></a>
                      </td>
                      <td>
                        <!-- <a href="add-schedule.php?id=<?php echo base64_encode($row['id']); ?>"><i class="fa fa-edit"></i></a> -->
                        ||
