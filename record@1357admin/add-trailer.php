...
if (isset($_REQUEST['submit'])) {
  ...
  if ($result === true) :
    $msg = 'Trailer has been created successfully ..';
  else :
...
if (isset($_REQUEST['update'])) {
  ...
  if ($result === true) {
    $msg = 'Trailer has been updated successfully ..';
      ...
      <div class="col-xs-12">
        <div class="box box-warning">
          <div class="box-header with-border">
            <?php if (empty($id)) : ?>
              <h3 class="box-title">Add Trailer</h3>
            <?php else : ?>
              <h3 class="box-title">Update Trailer</h3>
            <?php endif; ?>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <form name="myFilms Winner" id="myFilms Winner" method="post" class="form-horizontal" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <select class="form-control" name="category" required>
                    ...
                    <?php foreach ($function->getAllItems("trailer_category") as $key => $item) : ?>
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-4">
                  <a href="/record@1357admin/view-trailers.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Go Back</a>
                </div>
              </div>
              <div class="form-group">
