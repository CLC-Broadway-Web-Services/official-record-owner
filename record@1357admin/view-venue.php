...
<div class="content-wrapper">
  <section class="content-header">
    <h1> Manage Venue <small>View Venue</small> </h1>
    <ol class="breadcrumb">
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View Venue</h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <a href="add-venue.php" class="btn btn-success" style="float: right;">Add Venue</a>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="add-venue.php?id=<?php echo base64_encode($row['id']); ?>"><i class="fa fa-edit"></i></a>
                        ||
