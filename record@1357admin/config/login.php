...
class Login {
	...
	public function loginData($email,$pass) {
		...
		if($result!=''){
			...
			$conn->updateExecute("UPDATE `tbl_admin` SET 
...
class SignOut {
	...
	public function Logout() {
		...
		session_destroy();
		echo "<script>window.location.href='http://".$db->globalLink()."/official-film-agency/rbs@1357admin/'</script>";
	}	
