      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View Jury</h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <a href="add-jury.php" class="btn btn-success" style="float: right;">Add Jury</a>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="add-jury.php?id=<?php echo base64_encode($row['id']); ?>"><i class="fa fa-edit"></i></a>
                        ||
