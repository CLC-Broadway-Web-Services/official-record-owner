...
<div class="content-wrapper">
  <section class="content-header">
    <h1> Manage Trailers <small>View Trailers</small> </h1>
    <ol class="breadcrumb">
      <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">View Trailers</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View Trailers</h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <a href="add-trailer.php" class="btn btn-success" style="float: right;">Add Trailers</a>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  foreach ($cateogryQuery as $row) :
                    $category = $function->getSingleItem($row['category'],"trailer_category")['name'];
                  ?>
                    <tr>
                      <td><?php echo $i++; ?></td>
                      ...
                      <td>
                        <a href="add-trailer.php?id=<?php echo base64_encode($row['id']); ?>"><i class="fa fa-edit"></i></a>
                        ||
