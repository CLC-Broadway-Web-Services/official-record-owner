...
if (isset($_REQUEST['submit'])) {
  ...
  if ($result === true) :
    $msg = 'Official submission has been created successfully ..';
  else :
...
if (isset($_REQUEST['update'])) {
  ...
  if ($result === true) {
    $msg = 'Official submission has been updated successfully ..';
...
<div class="content-wrapper">
  <section class="content-header">
    <h1> Manage Official submission </h1>
    <ol class="breadcrumb">
      <li><a href="/record@1357admin/home.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Add Official submission</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box box-warning">
          <div class="box-header with-border">
            <?php if (empty($id)) : ?>
              <h3 class="box-title">Add Official submission</h3>
            <?php else : ?>
              <h3 class="box-title">Update Official submission</h3>
            <?php endif; ?>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <form name="myFilms Winner" id="myFilms Winner" method="post" class="form-horizontal" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <select class="form-control" name="category" required>
                    ...
                    <?php foreach ($function->getAllItems("official_selection_category") as $key => $item) : ?>
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-4">
                  <a href="/record@1357admin/view-official-submission.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Go Back</a>
                </div>
              </div>
              <div class="form-group">
