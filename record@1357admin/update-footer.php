...
if (isset($_REQUEST['update'])) {
  ...
  if ($result === true) {
    $msg = 'footer has been updated successfully ..';
    $editval = $function->getSingleItem($id, $table);
  } else {
      ...
      <div class="col-xs-12">
        <div class="box box-warning">
          <div class="box-header with-border">
            <?php if (empty($id)) : ?>
              <h3 class="box-title">Add footer</h3>
            <?php else : ?>
              <h3 class="box-title">Update footer</h3>
            <?php endif; ?>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <form name="myfooter" id="myfooter" method="post" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-4">
                  <a href="/record@1357admin/view-footer.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Go Back</a>
                </div>
                <div class=" col-sm-4">
