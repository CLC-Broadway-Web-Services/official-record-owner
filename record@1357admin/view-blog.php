...
if (isset($_REQUEST['delete']) && $_REQUEST['delete'] == 'y') {
  ...
  $sqlDelete = $db->execute("DELETE FROM `blog` WHERE `id` = '$id'");
  if ($sqlDelete == true) :
...
if (isset($_REQUEST['status'])) {
  ...
  $sqlStatus = $db->execute("UPDATE `blog` SET `status` = '$status' WHERE `id` = '$id'");
}

$cateogryQuery = $function->getAllItems("blog");
