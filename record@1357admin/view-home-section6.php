...
$section6Data = $function->getAllItems($table);
?>

<div class="content-wrapper">
  <section class="content-header">
    <h1> Manage Home section6 <small>View Home section6</small> </h1>
    <ol class="breadcrumb">
      <li><a href="/record@1357admin/home.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"> View Home section6</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View Home section6</h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <a href="/record@1357admin/update-home-section6.php" class="btn btn-success" style="float: right; margin-bottom:20px">Add Testimonial</a>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                  foreach ($section6Data as $key => $row) :
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="update-home-section6?id=<?php echo base64_encode($row['id']); ?>"><i class="fa fa-edit"></i></a>
                        ||
