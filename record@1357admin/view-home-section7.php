...
$section7Data = $function->getAllItems($table)[0];
?>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View Home section7</h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>Title</td>
                    <td><?php echo $section7Data['title']; ?></td>
                  </tr>
                  <tr>
                    <td>Heading</td>
                    <td><?php echo $section7Data['heading']; ?></td>
                  </tr>
                  <tr>
                    <td>Button Text</td>
                    <td> <?php echo $section7Data['description']; ?></td>
                  </tr>
