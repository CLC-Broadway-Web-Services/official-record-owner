...
if (isset($_POST['update'])) {
  ...
  if ($result === true) {
    $msg = 'Home section3 has been updated successfully ..';
  } else {
      ...
      <div class="col-xs-12">
        <div class="box box-warning">
          <div class="box-header with-border">
            <h3 class="box-title">Update Home section3 Items</h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <form name="myAboutUs" id="myAboutUs" method="post" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-4">
                  <a href="/record@1357admin/view-home-section3.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Go Back</a>
                </div>
                <div class=" col-sm-4">
