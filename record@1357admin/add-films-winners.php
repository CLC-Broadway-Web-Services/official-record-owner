...
if (isset($_REQUEST['submit'])) {
  ...
  if ($result === true) :
    $msg = 'Films Winner has been created successfully ..';
  else :
...
if (isset($_REQUEST['update'])) {
  ...
  if ($result === true) {
    $msg = 'Films Winner has been updated successfully ..';
      ...
      <div class="col-xs-12">
        <div class="box box-warning">
          <div class="box-header with-border">
            <?php if (empty($id)) : ?>
              <h3 class="box-title">Add Films Winner</h3>
            <?php else : ?>
              <h3 class="box-title">Update Films Winner</h3>
            <?php endif; ?>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <select class="form-control" name="category" required>
                    ...
                    <?php foreach ($function->getAllItems("films_winners_category") as $key => $item) : ?>
