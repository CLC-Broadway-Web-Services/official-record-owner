...
if (isset($_REQUEST['status'])) {
  ...
  $sqlStatus = $db->execute("UPDATE `$table` SET `active` = '$status' WHERE `id` = '$id'");
}
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View Services Film </h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <!-- <a href="service-name-add.php" class="btn btn-success" style="float: right;">Add Services Film </a> -->
