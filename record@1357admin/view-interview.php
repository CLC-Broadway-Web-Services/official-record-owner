...
<div class="content-wrapper">
  <section class="content-header">
    <h1> Manage interviews <small>View interviews</small> </h1>
    <ol class="breadcrumb">
      <li><a href="/record@1357admin/home.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">View interviews</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View interviews</h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <a href="add-interview.php" class="btn btn-success" style="float: right;">Add interviews</a>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  foreach ($cateogryQuery as $row) :
                    $category = $function->getSingleItem($row['category'],"interview_category")['name'];
                  ?>
                    <tr>
                      <td><?php echo $i++; ?></td>
                      ...
                      <td>
                        <a href="add-interview.php?id=<?php echo base64_encode($row['id']); ?>"><i class="fa fa-edit"></i></a>
                        ||
