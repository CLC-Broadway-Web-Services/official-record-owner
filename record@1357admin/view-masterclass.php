...
<div class="content-wrapper">
  <section class="content-header">
    <h1> Manage Services Masterclass <small>View Services Masterclass</small> </h1>
    <ol class="breadcrumb">
      <li><a href="/record@1357admin/home.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">View Services Masterclass</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View Services Masterclass</h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <a href="add-services-pr.php" class="btn btn-success" style="float: right;">Add Services Masterclass</a>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="add-services-pr.php?id=<?php echo base64_encode($row['id']); ?>"><i class="fa fa-edit"></i></a>
                        ||
