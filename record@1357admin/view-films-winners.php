      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View Films Winners</h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <a href="add-films-winners" class="btn btn-success" style="float: right;">Add Films Winners</a>
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th>S.No</th>
                    <th>Films winners Name</th>
                    <th>Category</th>
                    <th>Image</th>
                    <th>Date</th>
                    <th>Status</th>
                ...
                <tbody>
                  ...
                  foreach ($cateogryQuery as $row) :
                    $category = $function->getSingleItem($row['category'],"films_winners_category")['name'];
                  ?>
                    <tr>
                      <td><?php echo $i++; ?></td>
