      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <a href="add-interview-category.php" class="btn btn-success" style="float: right;">Add <?= $pageName ?></a>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="add-interview-category.php?id=<?php echo base64_encode($row['id']); ?>"><i class="fa fa-edit"></i></a>
                        ||
