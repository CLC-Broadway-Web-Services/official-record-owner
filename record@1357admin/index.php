...
.btn-primary:hover, .btn-primary:active, .btn-primary.hover {border-color: #000;
    background-color: #000;
}
.login-box-body, .register-box-body { padding: 106px 49px;}
.login-box, .register-box {width: 464px;}
.icheck>label {padding-left: 20px;}
.checkbox input[type=checkbox], .checkbox-inline input[type=checkbox], .radio input[type=radio], .radio-inline input[type=radio] {margin-left: -19px !important;}</style>
</head>
    ...
    <div class="login-box-body">
      ...
      <form name="loginForm" id="loginForm" method="post">
        <div class="form-group has-feedback">
          <input type="email" name="email" value="<?php if (isset($_COOKIE["member_email"])) {
                                                    echo $_COOKIE["member_email"];
                                                  } ?>" class="form-control" placeholder="Email" required>
          <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
          <input type="password" name="password" value="<?php if (isset($_COOKIE["member_password"])) {
