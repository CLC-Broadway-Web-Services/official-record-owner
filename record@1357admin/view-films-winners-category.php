      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View <?= $pageName ?></h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                      <a href="/record@1357admin/view-films-winners-category.php?status=<?= $row['status'] ? 0 : 1 ?>&id=<?php echo $row['id']; ?>"><i class="fa fa-toggle-<?= $row['status'] ? "on" : "off" ?>"></i></a>

                      </td>
                      <td>
                        <a href="/record@1357admin/add-catalogue-category.php?id=<?php echo base64_encode($row['id']); ?>"><i class="fa fa-edit"></i></a>
                        ||
                        <a href="/record@1357admin/view-films-winners-category.php?id=<?php echo $row['id']; ?>&delete=y" onClick="return confirm('Are you sure !! Record will be delete parmanently ..!!')"><i class="fa fa-trash-o"></i></a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
