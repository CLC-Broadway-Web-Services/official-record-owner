...
$table = "official_selection_category";
$page = $table;
$function = new record();
...
if (isset($_REQUEST['submit'])) {
  ...
  if ($result === true) :
    $msg = 'catrgory has been created successfully ..';
  else :
      ...
      <div class="col-xs-12">
        <div class="box box-warning">
          <div class="box-header with-border">
              <h3 class="box-title">Update  <?= ucwords($page) ?></h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <?php } ?>
              ...
              <form name="my" id="my" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="col-sm-offset-2 col-sm-4">
                  <a href="/record@1357admin/view-official-submission-category.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Go Back</a>
                </div>
                <div class=" col-sm-4">
