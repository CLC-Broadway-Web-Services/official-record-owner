                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Career Detail</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <p><strong>Area of interest : </strong> <?= $row['interest'] ?></p>
                                                                    </li>
                                                                    <li>
                                                                        <p><strong>office preference : </strong> <?= $row['office_preference'] ?></p>
                                                                    </li>
                                                                    <li>
                                                                        <p><strong>current organisation : </strong> <?= $row['current_organisation'] ?></p>
                                                                    </li>
                                                                    <li>
                                                                        <p><strong>CV : </strong> <a target="_blank" href="dist/img/career/<?=$row['cv']?>"><i class="fa fa-file"></i></a></p>
                                                                    </li>
                                                                </ul>
                                                            </div>
