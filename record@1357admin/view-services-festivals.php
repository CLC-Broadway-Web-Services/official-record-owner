...
<div class="content-wrapper">
  <section class="content-header">
    <h1> Manage Services Fund <small>View Services Fund</small> </h1>
    <ol class="breadcrumb">
      <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">View Services Fund</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View Services Fund</h3>
          </div>
          <div class="box-body">
            <?php if (isset($msg)) { ?>
            ...
            <a href="add-services-festivals.php" class="btn btn-success" style="float: right;">Add Services Fund</a>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="add-services-festivals.php?id=<?php echo base64_encode($row['id']); ?>"><i class="fa fa-edit"></i></a>
                        ||
