...
$interviewData = data("interview", $idStatus, 2, $id);
$recentinterview = data("interview", $idStatus, 3, $id, 10);
$bannerData = data("pages_banner", 1, 2, 3);
$is_video = (!empty($interviewData['youtube'])) ? 1 : 0;
if ($is_video) {
	$youtubeLink = $interviewData['youtube'];
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="film-detail-video">
						...
						<?php } else { ?>
							<img src="record@1357admin/dist/img/<?= ($interviewData['image_detail']) ?>" height="500" width="1170" />
						<?php } ?>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-9">
					<div class="film-detail-title">
						<h3 class="section-title"> <?= $interviewData['heading']; ?> </h3>
					</div>

					<div class="film-detail-content">
						<?= $interviewData['description']; ?>
						<div class="mb-4"></div>
						<img src="record@1357admin/dist/img/<?= $interviewData['image1']; ?>" alt="img" />
						<div class="mb-4"></div>
						<?= $interviewData['description2']; ?>
					</div>
				</div>
				<div class="col-sm-3">
