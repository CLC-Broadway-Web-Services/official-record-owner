...
$films_winnersData = data("films_winners", $idStatus, 2, $id);
$recentfilms_winners = data("films_winners", $idStatus, 3, $id, 10);
$bannerData = data("pages_banner", 1, 2, 3);
$is_video = (!empty($films_winnersData['youtube'])) ? 1 : 0;
if ($is_video) {
	$youtubeLink = $films_winnersData['youtube'];
...
<div id="main">
						...
						<div class="text-center-sm">
							...
							<div class="breadcrumbs">
								<ul>
									...
									<li><?= ($films_winnersData['heading']); ?></li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="film-detail-video">
						...
						<?php } else { ?>
							<img src="record@1357admin/dist/img/<?= ($films_winnersData['image_detail']) ?>" height="500" width="1170" />
						<?php } ?>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-9">
					<div class="film-detail-title">
						<h3 class="section-title"> <?= $films_winnersData['heading']; ?> </h3>
					</div>

					<div class="film-detail-content">
						<?= $films_winnersData['description']; ?>
						<div class="mb-4"></div>
						<img src="record@1357admin/dist/img/<?= $films_winnersData['image1']; ?>" alt="img" />
						<div class="mb-4"></div>
						<?= $films_winnersData['description2']; ?>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="film-detail-info">
						<?= $films_winnersData['menu'] ?>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="section bg-light pt-7 pb-4">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<h3 class="section-title fz-24 fw-bolder bottom-line">Recent Winners</h3>
					<div class="relate-film-carousel row mt-5" data-auto-play="true" data-desktop="4" data-laptop="3" data-tablet="3" data-mobile="2">
						<?php foreach ($recentfilms_winners as $key => $item) : ?>
							<div class="item">
								<div class="item-inner">
									<div class="thumb">
										<a href="films-winners-detail.php?id=<?= base64_encode($item['id']) ?>">
											<img src="record@1357admin/dist/img/<?= ($item['image']) ?>" alt="" />
										</a>
									</div>
									<div class="info">
										<div class="title">
											<a href="films-winners-detail.php?id=<?= base64_encode($item['id']) ?>"><?= substr($item['heading'], 0, 20) ?></a>
										</div>
									</div>
								</div>
							</div>
